 ...
 */
enum OSTYPE {
    /** 128 байт, размер 32×32, MacOS v1.0, однобитный монохромнй значок */
    ICON=0,
    /** 256 байт, размер 32×32, MacOS v6.0, однобитный монохромнй значок с однобитной маской */
    ICN,
    /** 48 байт,  размер 16×12, MacOS v6.0, однобитный монохромнй значок с однобитной маской */
    icm,
    /** 96 байт,  размер 16×12, MacOS v7.0, 4-битный значок */
    icm4,
    /** 192 байт, размер 16×12, MacOS v7.0, 8-битный значок */
    icm8,
    /** 64 байт,  размер 16×16, MacOS v6.0, однобитный монохромнй значок с однобитной маской */
    ics,
    /** 128 байт, размер 16×16, MacOS v7.0, 4-битный значок */
    ics4,
    /** 256 байт, размер 16×16, MacOS v7.0, 8-битный значок */
    ics8,
    /** размер 16×16, MacOS v8.5, 24-битный RGB битмап */
    is32,
    /** 256 байт, размер 16×16, MacOS v8.5, 8-битная маска */
    s8mk,
    /** 512 байт, размер 32×32, MacOS v7.0, 4-битный значок */
    icl4,
    /** 1024 байт, размер 32×32, MacOS v7.0, 8-битный значок */
    icl8,
    /** размер 32×32, MacOS v8.5,  24-битный RGB битмап */
    il32,
    /** 1024 байт, размер 32×32, MacOS v8.5, 8-битная маска */
    l8mk,
    /** 576 байт, размер 48×48, MacOS v8.5, однобитный монохромнй значок с однобитной маской */
    ich,
    /** 1152 байт, размер 48×48, MacOS v8.5, 4-битный значок */
    ich4,
    /** 2304 байт, размер 48×48, MacOS v8.5, 8-битный значок */
    ich8,
    ...
    icp5,
    /** размер 48x48, MacOS v10.7, битмап JPEG 2000(X) или PNG(X) */
    icp6,
